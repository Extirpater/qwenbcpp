...
#pragma unroll
        for (int k = 0; k < KK / 4; k++) {
            ...
            vec_c[0] = vaddq_s16(vec_c[0], vreinterpretq_s16_s8(vec_v_left_1.val[0]));
            vec_c[0] = vaddq_s16(vec_c[0], vreinterpretq_s16_s8(vec_v_right_1.val[0]));
            vec_c[1] = vaddq_s16(vec_c[1], vreinterpretq_s16_s8(vec_v_left_1.val[1]));
            vec_c[1] = vaddq_s16(vec_c[1], vreinterpretq_s16_s8(vec_v_right_1.val[1]));
            ...
            vec_c[2] = vaddq_s16(vec_c[2], vreinterpretq_s16_s8(vec_v_left_2.val[0]));
            vec_c[2] = vaddq_s16(vec_c[2], vreinterpretq_s16_s8(vec_v_right_2.val[0]));
            vec_c[3] = vaddq_s16(vec_c[3], vreinterpretq_s16_s8(vec_v_left_2.val[1]));
            vec_c[3] = vaddq_s16(vec_c[3], vreinterpretq_s16_s8(vec_v_right_2.val[1]));
            ...
            vec_c[2] = vaddq_s16(vec_c[2], vreinterpretq_s16_s8(vec_v_left_3.val[0]));
            vec_c[2] = vaddq_s16(vec_c[2], vreinterpretq_s16_s8(vec_v_right_3.val[0]));
            vec_c[3] = vaddq_s16(vec_c[3], vreinterpretq_s16_s8(vec_v_left_3.val[1]));
            vec_c[3] = vaddq_s16(vec_c[3], vreinterpretq_s16_s8(vec_v_right_3.val[1]));
        }

        int32x4_t vec_v_bot_low_low_0  = vmovl_s16(vget_low_s16(vec_c[0]));
        int32x4_t vec_v_bot_low_high_0 = vmovl_high_s16(vec_c[0]);
        vst1q_s32(c + i + 0,  vaddq_s32(vld1q_s32(c + i + 0),  vec_v_bot_low_low_0));
        vst1q_s32(c + i + 4,  vaddq_s32(vld1q_s32(c + i + 4),  vec_v_bot_low_high_0));
        int32x4_t vec_v_bot_low_low_1  = vmovl_s16(vget_low_s16(vec_c[1]));
        int32x4_t vec_v_bot_low_high_1 = vmovl_high_s16(vec_c[1]);
        vst1q_s32(c + i + 8,  vaddq_s32(vld1q_s32(c + i + 8),  vec_v_bot_low_low_1));
        vst1q_s32(c + i + 12, vaddq_s32(vld1q_s32(c + i + 12), vec_v_bot_low_high_1));
        int32x4_t vec_v_bot_low_low_2  = vmovl_s16(vget_low_s16(vec_c[2]));
        int32x4_t vec_v_bot_low_high_2 = vmovl_high_s16(vec_c[2]);
        vst1q_s32(c + i + 16, vaddq_s32(vld1q_s32(c + i + 16), vec_v_bot_low_low_2));
        vst1q_s32(c + i + 20, vaddq_s32(vld1q_s32(c + i + 20), vec_v_bot_low_high_2));
        int32x4_t vec_v_bot_low_low_3  = vmovl_s16(vget_low_s16(vec_c[3]));
        int32x4_t vec_v_bot_low_high_3 = vmovl_high_s16(vec_c[3]);
        vst1q_s32(c + i + 24, vaddq_s32(vld1q_s32(c + i + 24), vec_v_bot_low_low_3));
        vst1q_s32(c + i + 28, vaddq_s32(vld1q_s32(c + i + 28), vec_v_bot_low_high_3));
    }
#endif
}
...
#pragma unroll
    for (int i = 0; i < BM3200_3200; i += 64) {
        // zero accumulators
        for (int j = 0; j < 8; ++j) vec_c[j] = vec_zero;
...
#pragma unroll
        ...
        // widen & store
        for (int b = 0; b < 8; ++b) {
            int32x4_t lo = vmovl_s16(vget_low_s16(vec_c[b]));
            int32x4_t hi = vmovl_high_s16(vec_c[b]);
            int off = i + b * 8;
            vst1q_s32(c + off + 0, vaddq_s32(vld1q_s32(c + off + 0), lo));
            vst1q_s32(c + off + 4, vaddq_s32(vld1q_s32(c + off + 4), hi));
        }
    }
#endif
}
